...
| Template publishing | Publish from My Slides supports private/shared visibility and owner/admin governance actions, including ownership transfer handoff controls. | No explicit collaborator role matrix (editor/reviewer/viewer) or approval workflow yet. | SLD-FE-410, SLD-BE-410 |
...
| SLD-FE-410 | Template ownership transfer controls | Frontend | P1 | In Progress (2026-04-25) | Owner/admin can transfer template ownership without dead-end manual remediation. |
| SLD-BE-410 | Template ownership transfer contract + target-user authorization | Backend | P1 | In Progress (2026-04-25) | API enforces owner/admin transfer rights and verifies destination account has slides access. |
...
1. SLD-FE-410 + SLD-BE-410: Expand ownership transfer into full collaborator roles and approval workflows.
