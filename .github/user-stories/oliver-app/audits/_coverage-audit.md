...
- Slide module is still import-first: there is no persisted slide/template library, editable canvas workflow, or export pipeline in production code yet.
...
- Slide module expectation drift: registry/UX copy and roadmap language can imply template/export/editor capabilities beyond what `/slides` currently ships.
