...
| B-010 | Admin shortcuts and admin route access | src/app/page.tsx; src/app/admin/page.tsx; src/context/UserContext.tsx | US-OLV-011, US-OLV-012 | Full | Manual review | src/app/admin/page.tsx | Admin access now depends on the mounted UserProvider resolving an admin role from `app_users`; hub shortcuts are rendered in the session bar. |
