...
| US-SLD-005 | Include Slides in Coverage and Verification Audits | Code Present | Manual review | Weak | /.github/oliver-app/index.md; audits/_coverage-audit.md; audits/_traceability-matrix.md | Audit/index inclusion is explicit. |
